"""YOLO26 Real-Time Object Detection Demo.

A Streamlit web application that performs real-time object detection using the
YOLO26 model and webcam input. The app processes video frames through streamlit-webrtc
and displays annotated results with detected objects.
"""
